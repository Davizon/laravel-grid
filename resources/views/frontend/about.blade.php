                  ...
                  <div class="About__information">
                      ...
                      <div class="About__information--details">
                        <div>
                           ...
                           <p> Somos una gran empresa.</p>
                           <p> Vendemos autos de calidad.</p>
                           <p> Fundada el 27 de julio del 2003.</p>
                           <p> Record mejores ventas en el año 2018.</p>
                           <p> Record por fabricar el auto mas veloz 2016.</p>
                           <p> Record a la venta de autos mas seguros 2015. </p>
                           <p> Rifa anual de uno de nuestros autos para nuestros clientes. </p>
                           <p> Festivales de carreras de autos anuales para nuestros clientes. </p>
                           <p> Empezamos como 5 miembros, y hoy ya sumamos mas de mil empleados. </p>
                           <p> Patrocinamos empresas pequeñas que quieran emprender. </p>
                        </div>
                      </div>
                    </div>
